...
[Collins et al](https://arxiv.org/abs/2210.09181) formulated a Bayesian approach to Projection Pursuit Regression and while attractive, [their code](https://github.com/gqcollins/BayesPPR) is more research- than production-driven. [This implementation](https://github.com/gcbeck/bppr) takes the algorithm they came up with, strips out some of its scope, introduces incremental online updates and does as much of the heavy lifting as possible in cholesky-space, obviating lots of matrix decompositions and inversions. In C++. 
